...
for (const anchor of ["simultaneously-recorded-neurons", "tissue-mapped", "neural-recording-hours"]) test(`${anchor} share URLs preserve actual deployment, path and query`, () => {
