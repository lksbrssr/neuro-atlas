  ...
  return (
    <>
      <PlateHeader
        ...
        status="partial"
        description="Implanted-BCI funding flows. Live: the 2026 year-to-date tally and deal list from the Q1+ market memo. Next: the venture / non-dilutive / public / strategic split, and the cumulative funding curve back through 2024."
      />

      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="card p-5">
          <h2 className="mb-1 text-sm font-semibold">New capital by year</h2>
        ...
        <div className="card p-5">
          <h2 className="mb-1 text-sm font-semibold">2026 rounds tracked</h2>
