  ...
  return (
    <>
      <PlateHeader
        ...
        status="live"
        description="Five instruments, read honestly: where a reading is live it carries a date, a source, and a chart you can drag to measure. Where it is not, we name the metric we intend to use and what is blocking it — an honest 'unwired' is a correct answer."
      />
